...
- `EEPROM_TRACK_HEADS_ADDRESS`: The EEPROM address for storing the track head positions.
- `EEPROM_TRACK_TAILS_ADDRESS`: The EEPROM address for storing the track tail positions.
...
- `RELAY_BOARD1_ADDRESS`: The I2C address of the first relay board.
- `RELAY_BOARD2_ADDRESS`: The I2C address of the second relay board.
