...
const char* MQTT_TOPIC = "TMRCI/output/Pittsburgh/turntable/#"; // MQTT topic for subscribing to turntable commands. The ESP32 will listen for messages on this topic.
