...
const byte LATCH_595 = 6;                               // UPDATE ACCORDING TO PCB DESIGN***
const byte DATA_595 = 7;                                // UPDATE ACCORDING TO PCB DESIGN***
const byte CLOCK_595 = 8;                               // UPDATE ACCORDING TO PCB DESIGN***
...
void updateOutputs() {
  digitalWrite(LATCH_595, LOW);
  for (int i = 5; i >= 0; i--) {
    SPI.transfer(~last_output_state[i]); // Invert the bits to set LOW (active)
  }
